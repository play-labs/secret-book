...
class AppConfig {
  ...
  factory AppConfig.initial() {
    return const AppConfig(
      ...
      ossBucketName: 'secret-book',
      ossObjectKey: 'vault.bundle',
      stsApiUrl: 'https://ltp.playnb.net/config-center/api/v1/sts/assume-role',
  ...
  factory AppConfig.fromMap(Map<String, dynamic> map) {
    ...
    return AppConfig(
      ...
      ossEndpoint:
          map['ossEndpoint'] as String? ?? 'oss-cn-hangzhou.aliyuncs.com',
      ossBucketName: map['ossBucketName'] as String? ?? 'secret-book',
